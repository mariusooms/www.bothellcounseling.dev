...
/**
 * Upgrade the database to version 2102.
 *
 * @since 2.1.0
 *
...
function genesis_upgrade() {
	...
	###########################
	# UPDATE DB TO VERSION 2102
	###########################

	if ( genesis_get_option( 'db_version', null, false ) < '2102' )
		genesis_upgrade_2102();
