...
function genesis_post_info() {
	...
	$entry_meta = apply_filters( 'genesis_post_info', '[post_date] ' . __( 'by', 'genesis' ) . ' [post_author_posts_link] [post_comments] [post_edit]' );

	genesis_markup( array(
		'html5'   => '<p %s>' . $entry_meta . '</p>',
		'xhtml'   => sprintf( '<div class="post-info">%s</div>', $entry_meta ),
...
function genesis_post_meta() {
	...
	$entry_meta = apply_filters( 'genesis_post_meta', '[post_categories] [post_tags]' );

	genesis_markup( array(
		'html5'   => '<p %s>' . $entry_meta . '</p>',
		'xhtml'   => sprintf( '<div class="post-meta">%s</div>', $entry_meta ),
